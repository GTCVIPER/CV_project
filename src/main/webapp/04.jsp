        ...
        <div style="padding: 15px;">
            ...
            <div class="demoTable">
                ...
                <div class="layui-inline">
                    <input class="layui-input" name="acNumber" id="demoReload" autocomplete="off">
                </div>
            ...
            <script type="text/html" id="student-edit-layer">
                <form action="" method="post" id="student-edit-form" style="width: 80%" class="layui-form"
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">文章发布时间</label>
                        <div class="layui-input-block">
                            <label>
                                <input type="date" name="acTime" required lay-verify="required" placeholder="请输入文章发布时间"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <label>
                               <textarea name="acContent" type="text"  required lay-verify="required" rows="100" placeholder="请输入发布内容" autocomplete="off" class="layui-input">
    ...
    layui.use(['table', 'layer', 'form', 'element', 'jquery'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'acNumber', title: 'ID', width: 100, fixed: 'left', unresize: true, sort: true}
                , {field: 'acTime', title: '文章发布时间', width: 120, edit: 'text',templet(date) {
                        if (date.acTime != null && date.acTime !== "") {
                            return layui.util.toDateString(date.acTime, 'yyyy-MM-dd')
                        }
                    }}
                , {field: 'acContent', title: '发布内容', width: 110}
        ...
        function openEditWindow(data) {
            layer.open({
                ...
                yes: function (index, layero) {
                    layer.load();
                    $.ajax({
                        url: '/comm/comm' + (data == null ? 'Add' : 'Update'),
