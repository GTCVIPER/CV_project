        ...
        <div style="padding: 15px;">
                ...
                <form action="" method="post" id="student-edit-form" style="width: 80%" class="layui-form"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <label>
                                <input type="date" name="cTime" required lay-verify="required" placeholder="请输入审核时间"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <label>
                               <textarea name="cText" type="text"  required lay-verify="required" rows="100" placeholder="请输入审核内容" autocomplete="off" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="cState" title="待审核" value="0" checked/>
                            <input type="radio" name="cState" title="未通过" value="1"/>
                            <input type="radio" name="cState" title="通过" value="2"/>
                        </div>
                    </div>
            ...
            <script type="text/html" id="student-add-layer">
                <form action="" method="post" id="coustomer-add-form" style="width: 80%" class="layui-form"
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">APPID 提交编号</label>
                        <div class="layui-input-block">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">PID 材料编号</label>
                        <div class="layui-input-block">
                            <select name="pId" lay-verify="required">
                                <option value=""></option>
                                <c:forEach items="${pinos}" var="pino">
    ...
    layui.use(['table', 'layer', 'form', 'element', 'jquery'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'cTime', title: '审核时间', width: 120, edit: 'text',templet(date) {
                        if (date.cTime != null && date.cTime !== "") {
                            return layui.util.toDateString(date.cTime, 'yyyy-MM-dd')
                        }
                    }}
                , {field: 'appId', title: '材料编号 (APPID)', width: 110}
                , {field: 'pId', title: '提交编号 (PID)', width: 110}
                , {field: 'cText', title: '审核内容', width: 110}
                , {
                    field: 'cState', title: '审核状态', width: 180, templet(data) {
                        if (data.cState === 0) return '<span class="layui-badge layui-bg-gray">未审核</span>'
                        else if (data.cState === 1) return '<span class="layui-badge layui-bg-red">审核未通过</span>'
                        else if (data.cState === 2) return '<span class="layui-badge layui-bg-green">审核已通过</span>'
                    }
                }
        ...
        function openEditWindow(data) {
            layer.open({
                ...
                yes: function (index, layero) {
                    layer.load();
                    $.ajax({
                        url: '/check/check' + (data == null ? 'Add' : 'Update'),
