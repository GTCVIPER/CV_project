        ...
        <div style="padding: 15px;">
            ...
            <div class="demoTable">
                ...
                <div class="layui-inline">
                    <input class="layui-input" name="appId" id="demoReload" autocomplete="off">
                </div>
                ...
                <form action="" method="post" id="student-edit-form" style="width: 80%" class="layui-form"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <label>
                                <input type="date" name="appTime" required lay-verify="required" placeholder="请输入提交日期"
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">入党申请书内容</label>
                        <div class="layui-input-block">
                            <label>
                               <textarea name="appText" type="text"  required lay-verify="required" rows="100" placeholder="请输入入党申请书内容" autocomplete="off" class="layui-input">
...
<%--                        <div class="layui-input-block">--%>
<%--                            <label>--%>
<%--                                <input type="number" name="cId" required lay-verify="required" placeholder="请输入CID"--%>
<%--                                       autocomplete="off" class="layui-input">--%>
<%--                            </label>--%>
<%--                        </div>--%>
<%--                    </div>--%>
    ...
    layui.use(['table', 'layer', 'form', 'element', 'jquery'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'appId', title: 'ID', width: 100, fixed: 'left', unresize: true, sort: true}
                , {field: 'appTime', title: '提交时间', width: 120, edit: 'text',templet(date) {
                        if (date.appTime != null && date.appTime !== "") {
                            return layui.util.toDateString(date.appTime, 'yyyy-MM-dd')
                        }
                    }}
                , {field: 'appText', title: '入党申请书内容', width: 110}
                , {field: 'sId', title: '学生账号', width: 180, edit: 'text'}
        ...
        function openEditWindow(data) {
            layer.open({
                ...
                yes: function (index, layero) {
                    layer.load();
                    $.ajax({
                        url: '/app/app' + (data == null ? 'Add' : 'Update'),
